...
function Services() {
  ...
  React.useEffect(() => {
    ...
    const updateView = () => {
      var contentServices = document.getElementsByClassName("cd-section");
      ...
      for (let i = 0; i < contentServices.length; i++) {
        ...
        if (
          contentServices[i].offsetTop - window.innerHeight / 2 <
            window.pageYOffset &&
          contentServices[i].offsetTop +
            contentServices[i].scrollHeight -
